...
public class tv-v1 implements SourceReader {


	/**
	 * The instance of logger used inside tv-v1
	 */
	...
	public tv-v1() {
		...
		this.logger.info("Service tv-v1 successfully started");
	}
